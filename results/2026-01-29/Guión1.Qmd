...
| Comando   | Función   |
| --------- |:--------- |
| pwd (donde estoy)    | Conocer la dirección absoluta del directorio actual |
...
| ls | Saber qué hay en esta carpeta |
| clear | Borrar el contenido del terminal |
| sudo | Ejecuta un comando con permisos de administrador |
| man a | ayuda para saber cómo funciona el comando a |
...
if [ ! -e aln_Chr17.FASTA ]; then
   ...
   # Ejemplo ajustando penalizaciones
...
```
**NO HE PODIDO DESCARGAR EXONERATE DESDE EL ORDENADOR VIRTUAL YA QUE NO TENGO PERMISOS. TAMPOCO HE PODIDO HACERLO DESDE INTERNET**
