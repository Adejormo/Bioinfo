...
En la primera columna uno es gca y otro es gcf. Esto es porque son registros de la base de datos propia y otro de la base de datos compartida, no tiene mayor importancia
2. Busca una función de R que te permita identificar las líneas repetidas en un
   marco de datos.
   hay una fución que se llama duplicated que nos dice si hay lineas repetidas
:::
...
Cosas:
chmod u+x ~/bin/data*
Rosca, set wd para trabajar en la carpeta que queremos
Guardar guion en file, save as para trabajr sobre esa copia
