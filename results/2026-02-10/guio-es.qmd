...
Si, asi podemos guardar ahi archivos pesados que no estorben en la carpeta de resultados
...
- ¿De cuántas secuencias diferentes se compone este genoma de referencia?
  3 secuencias, lo vemos ejecutando grep ">" archivo. Si queremos ver las líneas que llevan el signo > solo al principio usamos "^>"
:::
